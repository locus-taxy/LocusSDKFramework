...
#ifndef LOCUSSDKFRAMEWORK_SWIFT_H
#define LOCUSSDKFRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LocusSDKFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC17LocusSDKFramework14CBPinEntryView")
...
@interface CBPinEntryView (SWIFT_EXTENSION(LocusSDKFramework)) <UITextFieldDelegate>
- (BOOL)textField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
@end



SWIFT_CLASS("_TtC17LocusSDKFramework11EasyTipView")
...
@interface EasyTipView (SWIFT_EXTENSION(LocusSDKFramework)) <UIGestureRecognizerDelegate>
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer * _Nonnull)_ SWIFT_WARN_UNUSED_RESULT;
@end


@interface EasyTipView (SWIFT_EXTENSION(LocusSDKFramework))
- (void)handleRotation;
@end
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC17LocusSDKFramework19YPDrawSignatureView")
