...
#ifndef LOCUSFRAMEWORK_SWIFT_H
#define LOCUSFRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LocusFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC14LocusFramework14CBPinEntryView")
...
@property (nonatomic) IBInspectable CGFloat underLineThickness;
...
@interface CBPinEntryView (SWIFT_EXTENSION(LocusFramework)) <UITextFieldDelegate>
- (BOOL)textField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
@end



SWIFT_CLASS("_TtC14LocusFramework11EasyTipView")
...
@interface EasyTipView (SWIFT_EXTENSION(LocusFramework)) <UIGestureRecognizerDelegate>
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer * _Nonnull)_ SWIFT_WARN_UNUSED_RESULT;
@end


@interface EasyTipView (SWIFT_EXTENSION(LocusFramework))
- (void)handleRotation;
@end


SWIFT_CLASS("_TtC14LocusFramework19LocusSDKOutStoreDao")
@interface LocusSDKOutStoreDao : RealmSwiftObject
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC14LocusFramework19YPDrawSignatureView")
...
- (void)touchesMoved:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)_;
- (void)touchesEnded:(NSSet<UITouch *> * _Nonnull)_ withEvent:(UIEvent * _Nullable)_;
@end
